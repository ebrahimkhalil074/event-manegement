...
const Organizer = ({item}) => {
  ...
  <div className="relative mx-4 mt-4 h-80 overflow-hidden  bg-white bg-clip-border text-gray-700 shadow-lg ">
    <img  className="items-center justify-center" src={img} alt="profile-picture" />
  </div>
