...
const About = () => {
    return (
        <div className=' space-y-10 p-10'>
            ...
            <h2 className='text-3xl font-extrabold '>Call or Whatsapp Us: +8801761037812</h2>
            <h2 className='text-3xl font-extrabold'>Email Us:mdebrahimkhalil074@gmail.com</h2>
            <h2 className='text-3xl font-extrabold'>Facebook:<a className='text-purple-600' href=' https://www.facebook.com/mdebrahimkholil.ebrahim.7/' > https://www.facebook.com/mdebrahimkholil.ebrahim.7/</a></h2>
        </div>
    );
};
